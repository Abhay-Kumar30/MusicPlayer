...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <p className='bg-black px-4py-1 px-4 py-1 cursor-pointer rounded-2xl'>Music</p>
      <p className='bg-black px-4py-1 px-4 py-1 cursor-pointer rounded-2xl'>Podcast</p>
